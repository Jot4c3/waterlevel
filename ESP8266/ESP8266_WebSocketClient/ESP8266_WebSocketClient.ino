...
const char* ssid     = "ALEXA"; //enter your ssid/ wi-fi(case sensitiv) router name - 2.4 Ghz only
const char* password = "Jojo1981";     // enter ssid password (case sensitiv)
char host[] = "http://whatwaterlevel.herokuapp.com/"; //enter your Heroku domain name like "espiot.herokuapp.com" 
...
void webSocketEvent(WStype_t type, uint8_t * payload, size_t length) { 
    ...
    switch(type) {
        case WStype_DISCONNECTED:
           ...
           Serial.println("Disconnected! WStype");
            break;
...
void setup() {
    ...
    Serial.println("Pass WebSocket.begin");
